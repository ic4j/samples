# IC4J Java sample demonstrating XML JAXB object serialization and deserialization to/from Candid Record type.
...
```
java -jar target/ic4j-sample-jaxb-0.6.18.jar
```
